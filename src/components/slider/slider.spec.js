describe('md-slider', function() {
  ...
  describe('reverse', function () {
    it('should set model on press', function() {
      var slider = setup('md-vertical md-reverse ng-model="value" min="0" max="100"');
      pageScope.$apply('value = 50');
    ...
    it('should decrement model on up arrow', function() {
      var slider = setup('md-vertical md-reverse min="100" max="104" step="2" ng-model="model"');
      pageScope.$apply('model = 104');
    ...
    it('should update the thumb text', function() {
      var slider = setup('md-vertical md-reverse ng-model="value" md-discrete min="0" max="100" step="1"');
      var wrapper = getWrapper(slider);
    ...
    it('should add _md-min class only when at min value', function() {
      var slider = setup('md-vertical md-reverse ng-model="model" min="0" max="30"');
      var wrapper = getWrapper(slider);
    ...
    it('should increment at a predictable step', function() {
      ...
      function buildSlider(step, min, max) {
        var slider = setup('md-vertical md-reverse ng-model="value" min="' + min + '" max="' + max + '" step="' + step + '"');
        pageScope.$apply('value = 0.5');
    ...
    it('should increment model on left arrow', function() {
      var slider = setup('md-reverse min="100" max="104" step="2" ng-model="model"');
      pageScope.$apply('model = 100');
